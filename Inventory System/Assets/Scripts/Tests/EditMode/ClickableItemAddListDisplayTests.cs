...
{
    public class ClickableItemAddListDisplayTests
    {
        private class TestClickableItemAddListDisplay : ClickableItemAddListDisplay
        {
        ...
        public void ConfigureSlot_SetIconForButton()
        {
            ...
            TestClickableItemAddListDisplay display = displayGameObject.AddComponent<TestClickableItemAddListDisplay>();
            display.SetFields();
